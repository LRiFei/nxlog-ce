...
void nx_expr_proc__om_file_rotate_to(nx_expr_eval_ctx_t *eval_ctx, nx_module_t *module, nx_expr_arg_list_t *args);
void nx_expr_proc__om_file_reopen(nx_expr_eval_ctx_t *eval_ctx, nx_module_t *module, nx_expr_arg_list_t *args);
